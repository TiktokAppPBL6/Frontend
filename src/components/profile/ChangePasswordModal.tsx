          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20 transition-all ${
                  errors.currentPassword ? 'border-red-500' : 'border-gray-200 focus:border-[#FE2C55]'
                }`}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20 transition-all ${
                  errors.newPassword ? 'border-red-500' : 'border-gray-200 focus:border-[#FE2C55]'
                }`}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20 transition-all ${
                  errors.confirmPassword ? 'border-red-500' : 'border-gray-200 focus:border-[#FE2C55]'
                }`}
