          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-140px)]">
            <div className="flex items-center gap-6 pb-6 border-b border-gray-200">
              <div className="relative">
                <Avatar 
                  ...
                  alt={user?.username} 
                  size="xl" 
                  className="h-24 w-24 ring-4 ring-gray-100" 
                />
                <label 
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20 focus:border-[#FE2C55] transition-all"
              ...
              <div className="bg-amber-50 border-2 border-amber-200 rounded-lg p-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400/20 transition-all ${
                      passwordError ? 'border-red-500' : 'border-amber-200 focus:border-amber-400'
                    }`}
            ...
            <div className="pt-4 border-t border-gray-200">
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 bg-gray-50 hover:bg-gray-100 border-2 border-gray-200 rounded-lg transition-colors"
                disabled={updateMutation.isPending}
              >
